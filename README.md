...
원본 `moneyroad-app`의 코드·Git 이력·브랜치와 개인 개발 기록을 보존한 비공개 저장소임.
...
문서 기본 화면은 `portfolio` 브랜치이며 원래 `main` 및 다른 브랜치는 별도로 보존함. Bambi 웹은 `develop`, 앱은 `mobile`과 진행 중 기능 브랜치를 함께 확인해야 함.
